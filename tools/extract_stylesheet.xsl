...
<xsl:stylesheet xmlns:exportformats="http://www.harctoolbox.org/exportformats" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:girr="http://www.harctoolbox.org/Girr"
    ...
    <xsl:template match="/exportformats:exportformat">
         <xsl:apply-templates select="xsl:stylesheet[1]"/>
    </xsl:template>
