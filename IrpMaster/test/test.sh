...
JAVA=java
LIBRARY_PATH=../Linux-amd64


PROG="$JAVA -Djava.library.path=$LIBRARY_PATH -jar $JARFILE -c $DATAFILE --decodeir --logfile +$LOGFILE"

date > $LOGFILE
$JAVA -Djava.library.path=$LIBRARY_PATH -jar $JARFILE -c $DATAFILE --decodeir --version >> $LOGFILE
